...
[![Profile CI](https://github.com/ultralytics/profile/actions/workflows/ci.yml/badge.svg)](https://github.com/ultralytics/profile/actions/workflows/ci.yml)
[![Ultralytics Actions](https://github.com/ultralytics/profile/actions/workflows/format.yml/badge.svg)](https://github.com/ultralytics/profile/actions/workflows/format.yml)
[![codecov](https://codecov.io/github/ultralytics/profile/branch/main/graph/badge.svg)](https://app.codecov.io/github/ultralytics/profile)
...
For bug reports or feature suggestions related to this template, please use [GitHub Issues](https://github.com/ultralytics/profile/issues). For other Ultralytics projects, please use the issue tracker for the relevant repository. For general questions, discussions, and community support, join our [Discord](https://discord.com/invite/ultralytics) server!
